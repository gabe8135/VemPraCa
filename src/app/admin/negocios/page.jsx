      ...
      try {
        const { data, error: fetchError } = await supabase
          ...
          .select(`
            ...
            imagens,
            profiles ( email )
          `) // Colunas que vou precisar. Adicionei 'profiles ( email )' para buscar o email do proprietário.
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Email Proprietário</th>
